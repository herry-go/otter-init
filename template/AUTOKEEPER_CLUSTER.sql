...
-- ----------------------------
BEGIN;
INSERT INTO `otter`.`AUTOKEEPER_CLUSTER`(`ID`, `CLUSTER_NAME`, `SERVER_LIST`, `DESCRIPTION`, `GMT_CREATE`, `GMT_MODIFIED`) VALUES (1, '{zk_cluster_name}', '[\"{zk_cluster_address}\"]', NULL, '2022-08-19 15:08:50', '2022-08-19 15:08:50');
COMMIT;
